...
public class ShoppingListActivity extends AppCompatActivity implements View.OnClickListener, View.OnKeyListener,
    ...
    private static ShoppingListActivity todolistclass;
    ...
    public static ShoppingListActivity getTodoLIst() {
